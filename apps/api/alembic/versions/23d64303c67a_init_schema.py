...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_event_categories_event_id'), 'event_categories', ['event_id'], unique=False)
    ...
    op.create_index(op.f('ix_event_occurrences_start_datetime_utc'), 'event_occurrences', ['start_datetime_utc'], unique=False)
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(op.f('ix_event_occurrences_start_datetime_utc'), table_name='event_occurrences')
