...
export default function FeaturedEventCard({ event }: Props) {
  ...
  const card = (
    <div
      ref={cardRef}
      className="relative flex min-h-[20rem] flex-col rounded-3xl border border-white/60 bg-gradient-to-br from-white/90 to-white/70 p-5 shadow-2xl shadow-coral/10 backdrop-blur-sm md:min-h-[24rem] dark:border-white/10 dark:bg-gradient-to-br dark:from-white/10 dark:to-white/5 dark:shadow-none"
    >
