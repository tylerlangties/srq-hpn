      ...
      <div className="grid gap-10 lg:grid-cols-[1.1fr_0.9fr] items-center">
        <div className="space-y-6 fade-up delay-1">
          ...
          <div className="flex flex-wrap gap-3">
            <Link
              href="/events"
              className="rounded-full bg-coral px-7 py-3.5 text-sm font-semibold text-white shadow-lg shadow-coral/40 hover:shadow-coral/50 hover:translate-y-[-2px] transition-all dark:bg-gradient-to-r dark:from-purple-600 dark:to-pink-600 dark:shadow-purple-500/30"
            >
              Browse events
            </Link>
            <Link
